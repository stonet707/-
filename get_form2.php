...
print "$xingming</br>$shenfenzheng</br>$temp</br>";
...
//                print "$getwork2</br>$endwork2</br>$danwei2</br>$keshi2</br>$zhiwu2</br>$comment2</br>";
            ...
            */
            ...
            $jiezhishijian=$row['baomingtime2'];
            ...
            if ($shaixuan_leixing=='专项招聘'&&($str<$shaixuan_time)){
                ...
                $query="DELETE FROM jibenxinxi WHERE resume_id='$resume_id'";
                mysql_query($query,$dbc);

                $query="DELETE FROM study WHERE resume_id='$resume_id'";
                mysql_query($query,$dbc);

                $query="DELETE FROM work1 WHERE resume_id='$resume_id'";
                mysql_query($query,$dbc);

                $query="DELETE FROM ability WHERE resume_id='$resume_id'";
                mysql_query($query,$dbc);


            }elseif($shaixuan_leixing=='专项招聘'&&$jiezhishijian<$edittime)
            {
                print "<div class='title2'>无法投递简历</div>";
                print "<div class='announ1'>&nbsp&nbsp&nbsp&nbsp&nbsp专项招聘期间投递简历时间要求为$baomingtime1-$baomingtime2,点击<a href='index.php' style='color: red'>这里</a>返回首页。</div>";
...
youjian='$youjian',dianhua='$dianhua',dizhi='$dizhi',jiguan='$jiguan',laiyuan='$laiyuan',edittime='$edittime',weixin='$weixin',zhiyezige='$zhiyezige'
...
//插入学习经历
                        if ($cengci1!='未选择') {
                            $query="UPDATE study SET cengci1='$cengci1',starttime1='$starttime1',endtime1='$endtime1',school1='$school1',major1='$major1',xingzhi1='$xingzhi1' WHERE resume_id='$resume_id'";
                            mysql_query($query,$dbc);

                            # code...
                        }else{
                            $query="UPDATE study SET cengci1=NULL,starttime1=NULL,endtime1=NULL,school1=NULL,major1=NULL,xingzhi1=NULL WHERE resume_id='$resume_id'";
                            mysql_query($query,$dbc);
                        }
                        if ($cengci2!='未选择') {
                            ...
                            $query="UPDATE study SET cengci2=NULL,starttime2=NULL,endtime2=NULL,school2=NULL,major2=NULL,xingzhi2=NULL WHERE resume_id='$resume_id'";
                            mysql_query($query,$dbc);
                        }
                        if ($cengci3!='未选择') {
                            ...
                            $query="UPDATE study SET cengci3=NULL,starttime3=NULL,endtime3=NULL,school3=NULL,major3=NULL,xingzhi3=NULL WHERE resume_id='$resume_id'";
                            mysql_query($query,$dbc);
                        }
...
//插入工作经历
                        ...
                        if ($getwork1!=NULL) {
                            ...
                            $query="UPDATE work1 SET getwork1='$getwork1',endwork1='$endwork1',danwei1='$danwei1',keshi1='$keshi1',zhiwu1='$zhiwu1',comment1='$comment1' WHERE resume_id='$resume_id'";
                            mysql_query($query,$dbc);
                            # code...
                        }else{
                            $query="UPDATE work1 SET getwork1=NULL,endwork1=NULL,danwei1=NULL,keshi1=NULL,zhiwu1=NULL,comment1=NULL WHERE resume_id='$resume_id'";
                            mysql_query($query,$dbc);
                        }
                        if ($getwork2!=NULL) {
                            ...
                            $query="UPDATE work1 SET getwork2=NULL,endwork2=NULL,danwei2=NULL,keshi2=NULL,zhiwu2=NULL,comment2=NULL WHERE resume_id='$resume_id'";
                            mysql_query($query,$dbc);
                        }
                        if ($getwork3!=NULL) {
                            ...
                            $query="UPDATE work1 SET getwork3=NULL,endwork3=NULL,danwei3=NULL,keshi3=NULL,zhiwu3=NULL,comment3=NULL WHERE resume_id='$resume_id'";
                            mysql_query($query,$dbc);
                        }

//插入专业能力信息
                        if ($zhicheng!=NULL&&$startjinxiu!=NULL) {
                            $query="UPDATE ability SET zhicheng='$zhicheng',qudetime='$qudetime',zhuan_ye='$zhuan_ye',
                        techang='$techang',startjinxiu='$startjinxiu',endjinxiu='$endjinxiu',miaoshu='$miaoshu' 
                        WHERE resume_id='$resume_id'";
                            mysql_query($query,$dbc);

                        }
                        else if ($zhicheng!=NULL&&$startjinxiu==NULL) {
                            $query="UPDATE ability SET SET zhicheng='$zhicheng',qudetime='$qudetime',zhuan_ye='$zhuan_ye',
                        techang=NULL,startjinxiu=NULL,endjinxiu=NULL,miaoshu=NULL
                        WHERE resume_id='$resume_id'";
                            mysql_query($query,$dbc);
                        }
                        else if ($startjinxiu!=NULL&&$zhicheng==NULL) {
                            $query="UPDATE ability SET zhicheng=NULL ,qudetime=NULL ,zhuan_ye=NULL,
                        techang=NULL,startjinxiu='$startjinxiu',endjinxiu='$endjinxiu',miaoshu='$miaoshu' 
                        WHERE resume_id='$resume_id'";
                            mysql_query($query,$dbc);
                            # code...
                        }else{
