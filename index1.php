...
<div class="main">
    ...
    <div class="main2">
        ...
        <div class="main2_right">
            ...
            <?php
                ...
                if ($result=mysql_query($mysql,$dbc)){
                    ...
                    if($leixing=='专项招聘'){
                        ...
                        $baomingtime1=$row['baomingtime1'];
                        $baomingtime2=$row['baomingtime2'];
                        ...
                        if ($resume_id==NULL){
                            if ($edittime>=$baomingtime1&&$edittime<=$baomingtime2){

                                print "<script>alert('您尚未投递简历，请设置登录密码以开始简历投递！')</script>";
                                ...
                                print "<form id='form2' name='form2' action=judge1.php method='post' onsubmit='return checkSubmit();'> 
                    <div class='box2'>
                        姓&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp名：$xingming
                    </div> 
                    <div class='box2'>
                        身&nbsp份&nbsp证&nbsp号:&nbsp&nbsp&nbsp$shenfenzheng
                    </div>
                    <div class='box2'>
                        输&nbsp入&nbsp密&nbsp码：<input type='password' id='mima' name='mima'>
                    </div> 
		            <div class='box2'>
		                确&nbsp认&nbsp密&nbsp码：<input type='password' id='queren' name='queren'></br>
                    </div>
                    <input type='hidden' name='xingming' value='$xingming'>
                    <input type='hidden' name='shenfenzheng' value='$shenfenzheng'>
                    <input type='hidden' name='yonghu' value='0'>
                    <div class='box1'>
                        <input type='submit' name='zhuce' class='inputsubmit' value='登录'>
                    </div>";
                            ...
                            print "<script>alert('您已经投递过简历，请输入密码来查看简历信息！')</script>";
                            ...
                            print "<div class='title2'>用户登陆/注册</div>";
                            print "<form id='form3' name='form3' action=judge1.php method='post' onsubmit='return checkSubmit();'>
            <div class='box2'>
                 姓&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp名：$xingming
            </div> 
            <div class='box2'>
            ...
            <div class='box2'>
                输&nbsp入&nbsp密&nbsp码：<input type='password' name='mima'>
            </div>
            <input type='hidden' name='xingming' value='$xingming'>
            <input type='hidden' name='shenfenzheng' value='$shenfenzheng'>
            <input type='hidden' name='yonghu' value='1'>
            <div class='box1'>
            <input type='submit' name='denglu' class='inputsubmit' value='登录'>
            </div>
            </form>";
