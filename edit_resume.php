...
<div class="main">
    ...
    <div class="main2">
        ...
        <div class="main2_right">
            ...
            <form id="myform" name="addcontent" action="get_form2.php" method="post" enctype="multipart/form-data" onsubmit="return checkSubmit();">
                <div class="cand">
                            ...
                            <div class='cand1'>
                            <dl>
                            <dd><b>*应聘岗位：</b><input name='gangwei' type='text' id='gangwei' value='{$row['gang']}' maxlength='50' class='intxt' onfocus='inputAutoClear(this)'/></dd>
                            <dt><b>1. 个人基本信息</b>（*为必填）</dt>";
                            print "<dd>*姓&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp名&nbsp：$xingming</dd>";
                            print "<dd>*身份证号：$shenfenzheng</dd>";

                            if ($row['xingbie']=="男"){
                                print "<dd>*性&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp别&nbsp：<input type='radio' name='xingbie' class='n' value='男' checked>男
                                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type='radio' name='xingbie' class='n' value='女'>女</dd>";
                            }else{
                                print "<dd>*性&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp别&nbsp：<input type='radio' name='xingbie' class='n' value='男'>男
                                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type='radio' name='xingbie' class='n' value='女' checked>女</dd>";
                            }
                            print "<dd>*出生日期：<input type='date' name='shengri' id='shengri'   class='y' value='{$row['shengri']}' /></dd>";
                            print "<dd>*民&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp族：<input type='text' name='minzu' id='minzu'   class='y' value='{$row['minzu']}' onfocus='inputAutoClear(this)' /></dd>";
//2017-10-18下午17：32
                            print "<dd>*户口所在地：<input type='text' name='sheng' id='sheng' class='cm' value=''>省<input type='text' name='shi' id='shi' class='cm' vlue=''>市(县)({$row['jiguan']})</dd>";
                            if ($row['yingjie']=="是"){
                                print "<dd>*是否毕业：<input type='radio' name='yingjie' class='n' value='是' checked>是
                                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type='radio' name='yingjie' class='n' value='否'>否</dd>";
                            }else{
                                print "<dd>*是否毕业：<input type='radio' name='yingjie' class='n' value='是' >是
                                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type='radio' name='yingjie' class='n' value='否' checked>否</dd>";
}
                            print "<dd>&nbsp职业资格:&nbsp&nbsp&nbsp<input type='text' name='zhiyezige' id='zhiyezige' class='ads' value='{$row['zhiyezige']}'></dd>";
                            print "<dd>*联系方式：<input type='text' name='dianhua' id='dianhua' class='ads' value='{$row['dianhua']}' /></dd>";
                            print "<dd>*电子邮件：<input type='text' name='youjian' id='youjian' class='ads' value='{$row['youjian']}' /></dd>";
                            print "<dd>*微信号：&nbsp&nbsp&nbsp<input type='text' name='weixin' id='weixin' class='ads' value='{$row['weixin']}' /></dd>";
                            print " <dd>*家庭住址：</dd>
                            <textarea name='dizhi' id='dizhi' rows='2' style='width:96%'>{$row['dizhi']}</textarea>
                        </dl>
                    </div>";

                            print "<div class='cand2'>
                        ...
                        <div class='cand2_td'>
                            ...
                            for($i=1;$i<4;$i++) {
                                ...
                                if ($row[$str1] == 1) {
                                    print "<select name='$str1' class='td1'>
                                    ...
                                    print "<input type='date' name='$str2' id='$str2' class='td3' value='$row[$str2]'>

                                    <input type='date' name='$str3' id='$str3' class='td3' value='$row[$str3]'>

                                    <input type='text' name='$str4' id='$str4' class='td3' value='$row[$str4]'>

                                    <input type='text' name='$str5' id='$str5' class='td3' value='$row[$str5]'>";
                                    if ($row[$str6] == "全日制") {
                                        print "<select name='$str6' class='td4'>
                                ...
                                }elseif ($row[$str1]==NULL||$row[$str1]=="未选择"){
                                    print "<select name='$str1' class='td1'>
                        ...
                        <div class='skill_td'>
                            <ul>
                                ...
                                <li>
                                    <input type='date' name='getwork1' id='getwork1' class='skill_td1' value='{$row['getwork1']}' />
                                    <input type='date' name='endwork1' id='endwork1' class='skill_td1' value='{$row['endwork1']}' />
                                    <input type='text' name='danwei1'  id='danwei1'  class='skill_td2' value='{$row['danwei1']}' />
                                    <input type='text' name='keshi1'   id='keshi1'   class='skill_td3' value='{$row['keshi1']}' />
                                    <input type='text' name='zhiwu1'   id='zhiwu1'   class='skill_td4' value='{$row['zhiwu1']}' />
                                    <input type='text' name='comment1' id='comment1' class='skill_td3' value='{$row['comment1']}' /></li>
                                <li>

                                    <input type='date' name='getwork2' id='getwork2' class='skill_td1' value='{$row['getwork2']}' />
                                    <input type='date' name='endwork2' id='endwork2' class='skill_td1' value='{$row['endwork2']}' />
                                    <input type='text' name='danwei2'  id='danwei2'  class='skill_td2' value='{$row['danwei2']}' />
                                    <input type='text' name='keshi2'   id='keshi2'   class='skill_td3' value='{$row['keshi2']}' />
                                    <input type='text' name='zhiwu2'   id='zhiwu2'   class='skill_td4' value='{$row['zhiwu2']}' />
                                    <input type='text' name='comment2' id='comment2' class='skill_td3' value='{$row['comment2']}' /></li>
                                <li>

                                    <input type='date' name='getwork3' id='getwork3' class='skill_td1' value='{$row['getwork3']}' />
                                    <input type='date' name='endwork3' id='endwork3' class='skill_td1' value='{$row['endwork3']}' />
                                    <input type='text' name='danwei3'  id='danwei3'  class='skill_td2' value='{$row['danwei3']}' />
                                    <input type='text' name='keshi3'   id='keshi3'   class='skill_td3' value='{$row['keshi3']}' />
                                    <input type='text' name='zhiwu3'   id='zhiwu3'   class='skill_td4' value='{$row['zhiwu3']}' />
                                    <input type='text' name='comment3' id='comment3' class='skill_td3' value='{$row['comment3']}' /></li>
                            </ul>
                        </div>
                    </div>";

                            print "<div class='zhuanye'>
                        <p>4. 专业能力</p>
                        <div class='zhuanye_td'>
                            <ul>
                                <li>
                                    <div class='zhuanye_td1'>职&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp称：</div>
                                    <input type='text' name='zhicheng' id='zhicheng' class='zhuanye_td2' value='{$row['zhicheng']}' >

                                    <div class='zhuanye_td3'>&nbsp&nbsp&nbsp&nbsp取得时间:</div>
                                    <input type='date' name='qudetime' id='qudetime' class='zhuanye_td2' value='{$row['qudetime']}'>

                                </li>

                                <li>
                                    <div class='zhuanye_td1'>专&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp业：</div>
                                    <input type='text' name='zhuan_ye' id='zhuan_ye' class='zhuanye_td2' value='{$row['zhuan_ye']}'>

                                    <div class='zhuanye_td3'>&nbsp&nbsp&nbsp&nbsp专业特长:</div>
                                    <input type='text' name='techang' id='techang' class='zhuanye_td2' value='{$row['techang']}'>
                                ...
                                <li>
                                    ...
                                    <input type='date' name='startjinxiu' id='startjinxiu' class='zhuanye_td2' value='{$row['startjinxiu']}'>

                                    <div class='zhuanye_td1'>&nbsp&nbsp&nbsp&nbsp结束时间:</div>
                                    <input type='date' name='endjinxiu' id='endjinxiu' class='zhuanye_td2' value='{$row['endjinxiu']}' >
                                </li>
                                ...
                                <textarea name='miaoshu' rows='4' style='width: 656px;'>{$row['miaoshu']}</textarea>
