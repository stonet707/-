...
<div class="main">
    ...
    <div class="main2">
        ...
        <div class="main2_right">
            ...
            if($yonghu=='0'){
                $query="SELECT * FROM jibenxinxi WHERE resume_id=(SELECT MAX(resume_id) FROM jibenxinxi)";
                $result=mysql_query($query,$dbc);
                $row=mysql_fetch_array($result);
                $resume_id=$row['resume_id']+1;
                $query="INSERT INTO jibenxinxi(resume_id,xingming,shenfenzheng,mima)VALUES('$resume_id','$xingming','$shenfenzheng','$mima')";
                if(mysql_query($query,$dbc)){
                    ob_end_clean();
                    header("Location:basicinfo.php?xingming=$xingming&&shenfenzheng=$shenfenzheng");
                    exit();
                }

            }elseif ($yonghu=='1'){
                $query="SELECT mima FROM jibenxinxi WHERE xingming='$xingming' AND shenfenzheng='$shenfenzheng'";
